...
class NN_1HL(object):
    ...
    def function_prime(self, thetas, input_layer_size, hidden_layer_size, num_labels, X, y, reg_lambda):
        ...
        d3V = a3 - Y.T
        d2V = np.dot(t2f.T, d3V) * self.activation_func_prime(z2)

        Delta2V = np.dot(d3V, a2)
        Delta1V = np.dot(d2V, a1)

        # print("neki1", Delta1.shape)
    ...
    def fit(self, X, y):
        ...
        #print(theta1_0.shape, theta2_0.shape)
